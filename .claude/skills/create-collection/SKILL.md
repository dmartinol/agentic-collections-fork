...
6. **Self-review checklist**
   ...
   - **Other long blocks:** use **`documentation_section`**, **`mcp_section`**, and **`security_model`** with either inline markdown (≤ **500** code points) or a one-line **`#fragment.md`** ref on that same key (same pattern as **`deploy_and_use`**; no `.catalog/` prefix in the ref string).
